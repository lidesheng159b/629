...
//        QMenu menu(this);
//
//        QAction* colorAction = menu.addAction(QStringLiteral("修改颜色"));
//        QAction* fillStyleAction = menu.addAction(QStringLiteral("修改填充样式"));
//
//        QAction* selectedItem = menu.exec(event->globalPos());
//
//        if (selectedItem == colorAction) {
//            // 处理修改颜色的操作
//            QColor newColor = QColorDialog::getColor(Qt::black, this, QStringLiteral("选择颜色"));
//            if (newColor.isValid()) {
...
//            {
//                painter_p.setPen(QPen(Qt::blue, 5));//画笔设置
